...
class notifyonSuccessRegistration(object):
    ...
    def notifyonSuccessRegistration_Logic(self):
        ...
        import threading
        heartBeatThread = threading.Thread(target=self.baseClass.msgHandler.trigggerHeartBeat)
...
class CreateAndSendRegisterMessage(object):
    ...
    def CreateAndSendRegisterMessage_Logic(self):
        self.InElem = self.baseClass.pyAAS.aasConfigurer.configureDescriptor()
    ...
    def create_Outbound_Message(self):
        ...
        for oMessage in self.oMessages:
            ...
            receiverId = "VWS_RIC"#message["frame"]["sender"]["identification"]["id"]
...
class Register(object):
    ...
    def Start(self, msgHandler, skillDetails):
        ...
        self.listHandler = serviceLogHandler(self.msgHandler.RegisterLogList)
