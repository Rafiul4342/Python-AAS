...
class TransportRequester(object):
    '''
    classdocs
    '''
    ...
    def __init__(self, pyAAS):
        ...
        self.SKILL_STATES = {
                          "WaitForSPProposal": "WaitForSPProposal",  "cfpConfiguration": "cfpConfiguration",  "sendCompletionResponse": "sendCompletionResponse",  "sendacceptProposal": "sendacceptProposal",  "WaitforInformConfirm": "WaitforInformConfirm",  "noProposalReceived": "noProposalReceived",  "WaitforNewOrder": "WaitforNewOrder",  "sendrejectProposal": "sendrejectProposal",  "SendCFP": "SendCFP",  "EvaluateProposal": "EvaluateProposal",
                       }
    ...
    def Start(self, msgHandler, skillDetails):
        ...
        self.listHandler = serviceLogHandler(self.msgHandler.TransportRequesterLogList)
